...
<head>
    ...
    <title>History &#8211; Feoux</title>   <link rel="icon" href="https://www.feoux.com/favicon.ico" type="image/x-icon"><link rel="icon" href="https://www.feoux.com/favicon.png" type="image/x-icon">
...
<link rel="stylesheet" href="https://www.feoux.com/font-awesome/css/all.css"><link rel="stylesheet" href="https://www.feoux.com/bootstrap/font/bootstrap-icons.css">
    ...
    <link rel='stylesheet' id='axil-fonts-css' href='https://fonts.googleapis.com/css?family=Red+Hat+Display3A02C4003B02C5003B02C7003B02C9003B12C4003B12C5003B12C7003B12C900&#038;subset=latin2Clatin-ext&#038;ver=5.7.2' type='text/css' media='all' />
    ...
    <link rel="alternate" type="application/json+oembed" href="../../wp-json/oembed/1.0/embed?url=http3A2F2Faxilthemes.com2Fthemes2Fblogar2Fmy-account2F" />
    <link rel="alternate" type="text/xml+oembed" href="../../wp-json/oembed/1.0/embed?url=http3A2F2Faxilthemes.com2Fthemes2Fblogar2Fmy-account2F&#038;format=xml" />
                    ...
                    <article id="post-795" class="post-795 page type-page status-publish hentry">
                        <div class="entry-content">
                            <div class="woocommerce">
                                 ...
                                 if ($count > 0) {
                                     ...
                                     while ($data = mysqli_fetch_assoc($res)) {
                                         $userid = $data['id'];
                                             ...
                                             require("../../dbcon.php");
                                             $ov= explode(" ",$view);
                                             $sql = "SELECT * FROM `post` WHERE `id`= '$ov[0]' 
                                             or `id` = '$ov[1]'
                                              or `id` = '$ov[2]' 
                                              or `id` = '$ov[3]'
                                              or `id` = '$ov[4]' 
                                             ...
                                             if ($count > 0) {
                                                 // Output the details within a table with Bootstrap styes
                                                 while ($data = mysqli_fetch_assoc($res)) {
                                                     $channel = $data['channel'];$channell = str_ireplace(' ', '-', $channel);
                                                     $title = $data['title'];
                                                     $desc = $data['desc'];
                                                     $date = $data['date'];
                                                     $img = $data['image'];
                                                     ...
                                                     <div class='content'>
                                                     <h6 class='post-author-name'><a style='text-decoration: none;' class='hover-flip-item-wrapper' href='../../channel/$channel/'>&nbsp;<img style='width: 40px;height: 40px;border-radius: 100px;object-fit: cover;' src='../../channel/$channel/avatar.jpg'>&nbsp;<span style='margin-top: 10px;'><span data-text='$channel' style='text-transform: capitalize;'>$channel</span></span></a></h6>
                                ...
                                ?>
                                <br><br><br><style>a{text-decoration: none;}</style>
                                <h2>Liked Video</h2>
                                <?php
                                 require("../../dbcon.php");
                                 $username = $_SESSION["username"];
                                 ...
                                 if ($count > 0) {
                                     ...
                                     while ($data = mysqli_fetch_assoc($res)) {
                                         $userid = $data['id'];
                                             require("../../cache/log/$userid/index.php");
                                             $ov= explode(" ",$follow);
                                             $sql = "SELECT * FROM `channel` WHERE `channel` like '%$ov[0]%' 
                     or `channel` like '%$ov[1]%'
                      or `channel` like '%$ov[2]%' 
                      or `channel` like '%$ov[3]%'
                      or `channel` like '%$ov[4]%' 
                      or `channel` like '%$ov[5]%'
                      or `channel` like '%$ov[6]%'
                      or `channel` like '%$ov[7]%'
                      or `channel` like '%$ov[8]%'
                      or `channel` like '%$ov[9]%'
                      or `channel` like '%$ov[10]%'
                      ORDER BY id LIMIT 10";
                                             ...
                                             if ($count > 0) {
                                                 ...
                                                 while ($data = mysqli_fetch_assoc($res)) {
                                                     ...
                                                     echo "
                                                     <div class='post-content' style='width: 15%;max-width: 20%;display: inline-flex;;/* display: flex; */position: relative;justify-content: flex-start;flex-wrap: nowrap;'>
                                                     <div style='background:whitesmoke;padding:10px;border-radius:10px;width: 100%;position: relative;'>
                                                     <center><h6 style='margin-bottom:0px;'>
                                                     <a style='text-decoration:none' href='../../channel/$channel/'>
                                                     &nbsp;<img style='width: 40px;height: 40px;border-radius: 100px;object-fit: cover;' src='../../channel/$channel/avatar.jpg'>
                                                     &nbsp;<span style='margin-top: 10px;'><span style='text-transform: capitalize;'>$channel</span>
                                                     </span></a></h6></center>
                                                     </div></div>&nbsp;";
                                                 }
                                             } else {
                                ...
                                ?>
                                </div><Br><Br><p><a href='../../editor/' style='padding:10px;background:red;color:white;text-decoration:none;border-radius:10px;display:inline'><i class="fas fa-paper-plane"></i> Your Channel</a>
                                <a href='../' style='padding:10px;background:red;color:white;text-decoration:none;border-radius:10px;display:inline'><i class="fas fa-home"></i> Home</a></div></p>
                    </article>
                </div>
            </div>
<style>.mainmenu-nav ul.mainmenu>li>a{color:#212121;}</style>
    ...
    <link rel='stylesheet' id='google-fonts-1-css' href='https://fonts.googleapis.com/css?family=&#038;display=auto&#038;ver=5.7.2' type='text/css' media='all' />
    ...
    <script type='text/javascript' id='elementor-frontend-js-before'>
        var elementorFrontendConfig = {
            ...
            "post": {
                "id": 795,
                "title": "My20account20E2809320Blogar",
                "excerpt": "",
                "featuredImage": false
            }
        };
