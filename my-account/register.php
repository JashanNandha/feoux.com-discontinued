...
<head>
    ...
    <title>Register &#8211; Feoux</title>
    <link rel="icon" href="https://www.feoux.com/favicon.ico" type="image/x-icon">
    <link rel="icon" href="https://www.feoux.com/favicon.png" type="image/x-icon">
    ...
    <div class="main-content">
        ...
        <div class="main-content">
            ...
            <div class="main-wrapper">
                                ...
                                <div class="woocommerce">
                                    ...
                                    <form action="" class="woocommerce-form woocommerce-form-login login" method="post">
                                        ...
                                        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                            ...
                                            <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="email" id="email" autocomplete="off" value="" />
                                        </p>
                                        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                            <label for="password">Phone No.&nbsp;<span class="required">*</span></label>
                                            <input class="woocommerce-Input woocommerce-Input--text input-text" type="text" name="phone" id="phone" autocomplete="off" />
                                        </p>


                                        <p class="form-row">
                                            <label class="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme">
                                                <input class="woocommerce-form__input woocommerce-form__input-checkbox" name="terms" type="checkbox" id="rememberme" value="forever" /> <span>You Agree and accept our <a href='../extra/terms-of-use/'>Terms and conditions</a></span>
                                            </label>

                                        </p>
                                        <p class="form-row"><button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="submit" value="submit">Next</button></p>
                ...
                <center>
                    <div id='caption' style='background: #ff7907;color: white;text-align: center;width: 50%;font-family: sans-serif;padding: 10px;border-radius: 10px;'>Email ID already in use<span style='left: 15%;position: relative;' class='fas fa-times' onclick='document.getElementById(`caption`).style.display=`none`;'></span></div>
            </center>
            </div>";
                                            } else {
                                                $sql = "INSERT INTO `user`(`email`, `phone`,`username`) VALUES ('$email','$phone',NULL)";
                                                if (mysqli_query($conn, $sql)) {
                                                    echo "<div style='z-index:100;position:absolute;width:100%;left: 0px;top:5%;'>
                  <center>
                      <div id='caption' style='background: #28a745;color: white;text-align: center;width: 50%;font-family: sans-serif;padding: 10px;border-radius: 10px;'>Verification email have sent<span style='left: 15%;position: relative;' class='fas fa-times' onclick='document.getElementById(`caption`).style.display=`none`;'></span></div>
              </center>
              </div>";
...
<body class="clean-body u_body"
                                                   ...
                                                   <tr>
                                                       <td class="v-container-padding-padding"
                                                           ...
                                                           <h3
                                                               ...
                                                               confirm your account. Just click the button below.
                                                           </h3>
                                                   ...
                                                   <tr>
                                                       <td class="v-container-padding-padding"
                                                           ...
                                                           <div align="center">
                                                               ...
                                                               <a href="https://feoux.com/my-account/verify/?email=' . $email . '&id=' . $id . '"
                                                                       ...
                                                                       style="display:block;padding:16px 21px 18px 20px;line-height:120%;"><span
                                                                           style="font-family: Cabin, sans-serif; font-size: 18px; line-height: 21.6px;"><strong><span
                                                                                   style="line-height: 21.6px; font-size: 18px;"><span
                                                                                       style="line-height: 21.6px; font-size: 18px;">Confirm
                                                                                       Your
                                                                                       Account</span></span></strong></span></span>
                                                               </a>
                                                               ...
                                                               <p style="font-size: 14px; line-height: 180%;"><span
                                                                       style="font-family: Cabin, sans-serif; font-size: 16px; line-height: 28.8px;">If youare unable to redirect to verification page just tap on this given link.&nbsp; <span
                                                                           style="color: #a738d5; font-size: 16px; line-height: 28.8px;"><a
                                                                               rel="noopener"
                                                                               href="https://feoux.com/my-account/verify/?email=' . $email . '&id=' . $id . '"
                                                                               target="_blank"><span
                                                                                   style="font-size: 16px; line-height: 28.8px;"><span
                                                                                       style="font-size: 16px; line-height: 28.8px;">https://feoux.com/my-account/verify/?email=' . $email . '&id=' . $id . '
                                                                                   </span></span> </a> </span>
                                                                               <span
   ...
   '; // The content-type header must be set when sending HTML email
                                                    ...
                                                    echo "<div style='z-index:100;position:absolute;width:100%;left: 0px;top:5%;'>
                  <center>
                      <div id='caption' style='background: #ef2d2d;color: white;text-align: center;width: 50%;font-family: sans-serif;padding: 10px;border-radius: 10px;'>Verification email can't be sent<span style='left: 15%;position: relative;' class='fas fa-times' onclick='document.getElementById(`caption`).style.display=`none`;'></span></div>
              </center>
              </div>";
                                                }
                                            };
