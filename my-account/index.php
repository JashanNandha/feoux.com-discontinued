...
<head>
    ...
    <title>My account &#8211; Feoux</title>   <link rel="icon" href="https://www.feoux.com/favicon.ico" type="image/x-icon"><link rel="icon" href="https://www.feoux.com/favicon.png" type="image/x-icon">
                    ...
                    <article id="post-795" class="post-795 page type-page status-publish hentry">
                        <div class="entry-content">
                            <div class="woocommerce">
                                ...
                                $sql = "SELECT `id`, `username`, `name`, `email`, `phone`, `password`, `dob`, `gender`, `avatar`, `adress` FROM `user` WHERE `username`='$username' or email='$username'";
                                ...
                                if ($count > 0) {
                                    ...
                                    while ($data = mysqli_fetch_assoc($res)) {
                                        ...
                                        $gender = $data['gender'];
                                        $img = $data['avatar'];
                                        $adress_old = $data['adress'];
                                        echo "<form class='woocommerce-form woocommerce-form-login login' method='post' action='reset.php'>
                                        <p><img src='$img' style='
                                            border-radius: 100%;
                                            width: 200px;
                                            object-fit:cover;
                                            height: 200px;
                                        '>&nbsp;&nbsp;&nbsp;&nbsp;<a href='update-avatar/' style='
                                            background: #ffffff;
                                            color: #3f51b5;
                                            border-radius: 10px;
                                        ...
                                        '><i class='bi bi-pencil'></i></a></p>
                                        <p class='woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide'>
                                            <label for='username'>Username</label>
                                            <input type='text' class='woocommerce-Input woocommerce-Input--text input-text' name='username' id='username' autocomplete='off' readonly value='$username' />
                                        </p>
                                        <p class='woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide'>
                                            <label for='fullname'>Fullname&nbsp;</label><span><img src='../assets/images/edit.png' style='width:35px;'></span>
                                            <input type='text' class='woocommerce-Input woocommerce-Input--text input-text' name='fullname' id='fullname' autocomplete='off' value='$name' />
                                        </p>
                                        <p class='woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide'>
                                            <label for='email'>Email Id</label>
                                            <input type='text' class='woocommerce-Input woocommerce-Input--text input-text' name='email' id='email' autocomplete='off' value='$email' readonly />
                                        </p>
                                        <p class='woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide'>
                                            <label for='phone'>Phone No</label>
                                            <input type='tel' class='woocommerce-Input woocommerce-Input--text input-text' name='phone' id='phone' autocomplete='off' value='$phone' readonly />
                                        </p>
                                        <p class='woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide'>
                                            <label for='dob'>Date of birth&nbsp;</label><span><img src='../assets/images/edit.png' style='width:35px;'></span>
                                            <input type='date' class='woocommerce-Input woocommerce-Input--text input-text' name='dob' id='dob' autocomplete='off' value='$dob' />
                                        </p>
                                        <p class='woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide'>
                                            <label for='gender'>Gender</label>
                                            <input type='text' class='woocommerce-Input woocommerce-Input--text input-text' name='gender' id='gender' autocomplete='off' value='$gender' readonly />
                                        </p>
                                        <p class='woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide'>
                                            <label for='adress'>Adress&nbsp;</label><span><img src='../assets/images/edit.png' style='width:35px;'></span>
                                            <input type='text' class='woocommerce-Input woocommerce-Input--text input-text' name='adress' id='adress' autocomplete='off' value='$adress_old' />
                                        </p>&nbsp;
    
    
                                        <p class='form-row'>
                                           <button type='submit' class='woocommerce-button button woocommerce-form-login__submit' name='submit' value='Log in'>Update</button>
                                           </p><p  class='form-row' style='float:none;'>
                                           <a href='logout.php' class='woocommerce-button button woocommerce-form-login__submit' value='Log in' style='text-align:center;background:#f44336;border:#f44336;color:white;'>Logout</a>
                                        </p></form>";
                                    }
                                } else {
                                    echo "error";
                                ...
                                ?>
                                </div><p><a href='../editor/' style='padding:10px;background:red;color:white;text-decoration:none;border-radius:10px;display:inline'><i class="fas fa-paper-plane"></i> Your Channel</a>
                                <a href='history/' style='padding:10px;background:red;color:white;text-decoration:none;border-radius:10px;display:inline'><i class="fas fa-clock"></i> History</a></div></p>
                    </article>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-3 col-lg-12 col-md-12">
                        <div class="copyright-right text-left text-xl-right mt_lg--20 mt_md--20 mt_sm--20">
                            <p class="b3">© <?php echo date("Y");?>. All rights reserved by <a href="../" target="_blank" rel="noopener">feoux.</a></p>
                        </div>
                    </div>
                </div>
            </div>
