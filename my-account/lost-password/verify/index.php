<?php
        if (isset($_POST['reset'])) {  // ?name=x@mail.com&id=x
            require("../../../dbcon.php");
            $pwd = $_POST['user_pwd'];
            ...
            if ($pwd == '') {
                ...
                if (mysqli_num_rows($results) > 0) {
                    ...
                    if (mysqli_query($conn, $sql)) {
                      ...
                      <center>
                          <div id='caption' style='background: #28a745;color: white;text-align: center;width: 50%;font-family: sans-serif;padding: 10px;border-radius: 10px;'>Password Reset sucessfull<span style='left: 15%;position: relative;' class='fas fa-times' onclick='document.getElementById(`caption`).style.display=`none`;'></span></div>
                  </center>
                  </div><script>
                  setTimeout(function(){
...
<head>
    ...
    <title>Verify &#8211; Feoux</title>   <link rel="icon" href="https://www.feoux.com/favicon.ico" type="image/x-icon"><link rel="icon" href="https://www.feoux.com/favicon.png" type="image/x-icon">
...
<header class="header axil-header header-style-1 header-light header-with-shadow   ">
                                ...
                                <div class="mainmenu-wrapper d-none d-xl-block">
                                    ...
                                    <nav class="mainmenu-nav d-none d-lg-block">
                                        <ul id="main-menu" class="mainmenu">
                                            <li id="menu-item-437" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-has-children menu-item-437 axil-post-type-page has-dropdown"><a href="../../../">Home</a>
                                            </li>
                                            <li id="menu-item-280" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-280 axil-post-type-page has-dropdown"><a href="../../../ask-now/">Ask truely</a>
                                            </li>
                                            <li id="menu-item-280" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-280 axil-post-type-page has-dropdown"><a href="../../../extra/Help/">Help</a>
                                            </li>
                                            ...
                                            <li id="menu-item-380" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-675 megamenu-wrapper axil-post-type-page has-dropdown"><a href="../../../extra/contact-us/">Contact Us</a>
                                            </li>
            ...
            <input type="text" name="input" title="Type to search Anything"  style="width:100%" class="form-control" placeholder="Search ..." autocomplete="off" value="" />
...
<form method="post" action="" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p>Lost your password? Create new password easily.Be careful while creating new password.Turn off all backround apps and use safe browser.</p>
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
		<label for="user_login">New Password</label>
		<input class="woocommerce-Input woocommerce-Input--text input-text" type="password" name="user_pwd" autocomplete="password" value="" id="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required  placeholder='Enter New Passowrd' required/>
	</p> &nbsp;&nbsp;&nbsp;   <div id="message" style="display: none;background:white;border-radius:10px;">
    ...
    <p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
		...
		<input class="woocommerce-Input woocommerce-Input--text input-text" type="password" id="pwd" autocomplete="password" value=""  placeholder='Confirm Password' required/>
	</p>
    <p style="display:none" class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
		<label for="user_login">Username or email</label>
		<input class="woocommerce-Input woocommerce-Input--text input-text" type="text" name="user_name" value="<?php $namel = $_GET['name'];
         echo"$namel" ?>"/>
	</p>
    <p style="display:none" class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
		<label for="user_login">Id</label>
		<input class="woocommerce-Input woocommerce-Input--text input-text" type="text" name="key" value="<?php  $idl =  $_GET['id'];echo"$idl" ?>"/>
	</p>
	<div class="clear"></div>
...
/* <![CDATA[ */
var wc_cart_fragments_params = {"ajax_url":"\/themes\/blogar\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/themes\/blogar\/?wc-ajax=%%endpoint%%","cart_hash_key":"wc_cart_hash_db7f793fd6d883aa1f9d28d99235f621","fragment_name":"wc_fragments_db7f793fd6d883aa1f9d28d99235f621","request_timeout":"5000"};
/* ]]> */
</script>
...
/* <![CDATA[ */
var sb_instagram_js_options = {"font_method":"svg","resized_url":"http:\/\/axilthemes.com\/themes\/blogar\/assets/content\/uploads\/sb-instagram-feed-images\/","placeholder":"http:\/\/axilthemes.com\/themes\/blogar\/assets/content\/plugins\/instagram-feed\/img\/placeholder.png"};
/* ]]> */
</script>
