...
if (isset($_POST['username'])) {
      ...
      if ($count > 0) {
        ...
        while ($data = mysqli_fetch_assoc($res)) {
            ...
            if ($userp == "$password") {
                ...
                echo "<meta name='viewport' content='width=device-width, initial-scale=1'><div style='z-index:100;position:absolute;width:100%;left: 0px;top:5%;'>
        <center>
            <div id='caption' style='background: #ff5722;color: white;text-align: center;width: 50%;font-family: sans-serif;padding: 10px;border-radius: 10px;'>Incorrect details<span style='left: 15%;position: relative;' class='fas fa-times' onclick='document.getElementById(`caption`).style.display=`none`;'></span></div>
    </center>
    </div>";
            }
        }
    ...
    <head>
        ...
        <title>Login &#8211; Feoux</title>   <link rel="icon" href="https://www.feoux.com/favicon.ico" type="image/x-icon"><link rel="icon" href="https://www.feoux.com/favicon.png" type="image/x-icon">
                                    ...
                                    <div class="woocommerce">
                                        ...
                                        <form class="woocommerce-form woocommerce-form-login login" method="post" action="">
                                            ...
                                            <center>
                                                ...
                                                <p class="form-row">
                                                    <a class="woocommerce-button button woocommerce-form-login__submit" style="background: white;border:1px solid blue;color:blue;" href="register.php">Register</a>
                                                </p>
                                            </center>
