...
p {
    position: relative;
                                            ...
                                            <p>
                                                ...
                                                <input type="text" name="name" id="name" autocomplete="name" value=""  placeholder='Enter your Fullname' required />
                                            </p>
                                            <p>
                                                <label for="dob">Date of Birth&nbsp;<span class="required">*</span></label>
                                                <input type="date" name="date" id="date" autocomplete="dateofbirth" placeholder='DOB' max="2008-01-01" required/>
                                            </p>
                                            <p>
                                                <label for="Gender">Gender&nbsp;<span class="required">*</span></label>
                                                <select  name="gender" style=' ;padding:10px;
    border-radius:10px;
    border:solid 1.5px black;
    background:#eceff1;
    left:10px' id="gender" autocomplete="gender" required/>
                                            ...
                                            <p>
                                                <label for="Adresss">Adress&nbsp;<span class="required">*</span></label>
                                                <textarea name="ad" style='border-radius:10px;
    border:solid 1.5px black;
    background:#eceff1;
    left:10px;' id="ad" placeholder='Adress' required></textarea>
                                            </p>
                                            <center>
          ...
          if (isset($_POST)) {
            if ($name == '') {
              echo "";
                ...
                $sql = "UPDATE `user` SET `name`='$name',`dob`='$date',`gender`='$gender',`avatar`='avatar/pre.ico',`adress`='$ad' WHERE id='$id'";
                if (mysqli_query($conn, $sql)) {
                  echo "<div style='z-index:100;position:absolute;width:100%;left: 0px;top:5%;'>
                  <center>
                      <div id='caption' style='background: #28a745;color: white;text-align: center;width: 50%;font-family: sans-serif;padding: 10px;border-radius: 10px;'>Registration Done<span style='left: 15%;position: relative;' class='fas fa-times' onclick='document.getElementById(`caption`).style.display=`none`;'></span></div>
              </center>
              </div><script>
              setTimeout(function(){
              window.location.href = 'uname.php';
              }, 2000);
              </script>";
                  ...
                  echo "<div style='z-index:100;position:absolute;width:100%;left: 0px;top:5%;'>
                  <center>
                      <div id='caption' style='background: #ef2d2d;color: white;text-align: center;width: 50%;font-family: sans-serif;padding: 10px;border-radius: 10px;'>Error!Retry once<span style='left: 15%;position: relative;' class='fas fa-times' onclick='document.getElementById(`caption`).style.display=`none`;'></span></div>
              </center>
