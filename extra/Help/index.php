...
<head>
    ...
    <title>Help - Feoux</title>   <link rel="icon" href="https://www.feoux.com/favicon.ico" type="image/x-icon"><link rel="icon" href="https://www.feoux.com/favicon.png" type="image/x-icon">
...
/* <![CDATA[ */
var _zxcvbnSettings = {"src":"http:\/\/axilthemes.com\/themes\/blogar\/assets/includes\/js\/zxcvbn.min.js"};
/* ]]> */
</script>
                                ...
                                <div class="mainmenu-wrapper d-none d-xl-block">
                                    ...
                                    <nav class="mainmenu-nav d-none d-lg-block">
                                        <ul id="main-menu" class="mainmenu">
                                            ...
                                            <li id="menu-item-280" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-675 megamenu-wrapper axil-post-type-page"><a style="color:#1e88e5" href="../../extra/Help/">Help</a>
                                            </li>
...
<div class="axil-breadcrumb-area breadcrumb-style-1 bg-color-grey">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="inner">
                    <ul id="breadcrumbs" class="axil-breadcrumb liststyle d-flex"><li class="item-home"><a class="bread-link bread-home" href="./" title="Home">Home</a></li><li class="separator separator-home">  </li><li class="item-current item-795"><span class="bread-current bread-795"> Help</span></li></ul>     
...
<form action="help-search/" method="get" class="woocommerce-ResetPassword lost_reset_password">
<style>
    ::-webkit-scrollbar {
    width: 10px;
    height: 10px;
    ...
    background: #f5f5f5;
                                        ...
                                        <div class="axil-search form-group" style='width:100%'>
                                             <button type="submit" name="search" class="search-button"><i class="fas fa-search"></i></button>
            <input style='max-width:100%' type="text" name="input" title="Type to search Anything" class="form-control" placeholder="Search forum..." autocomplete="off" value="">
...
<?php
                                require("../../dbcon.php");
                                $sql = "SELECT `id`, `que`, `sol`,`date` FROM `help` ORDER BY `date` DESC LIMIT 10";
                                $res = mysqli_query($conn, $sql);
                                $count = mysqli_num_rows($res);
                                if ($count > 0) {
                                    // Output the details within a table with Bootstrap styes
                                    while ($data = mysqli_fetch_assoc($res)) {
                                        ...
                                        echo "
                                        <center>
        <div style='background: #e9ecef;color: #495057;padding:10px;border: solid 1.5px #495057;width:60%;border-radius: 10px;'>
<button type='button' class='colla' id='btn' onclick='tt$id()' style='border:none;outline:none;color:#6c757d'><span>$que</span><i class='bi bi-caret-down-fill' id='$id'></i></button></div>
    <div class='content' id='a$id' style='background: rgb(206, 229, 255);width: 60%;border-radius: 10px;margin-top: 4px;padding: 10px;'>$sol</div></center>&nbsp;
<script>
function tt$id(){
...
<li id="menu-item-10" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-10"><a style="color:#1e88e5" href="../../extra/Help/">Help</a></li>
</ul>                                            </div>
                </div>
