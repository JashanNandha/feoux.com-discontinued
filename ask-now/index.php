...
<head>
    ...
    <title>Ask &#8211; Feoux</title>   <link rel="icon" href="https://www.feoux.com/favicon.ico" type="image/x-icon"><link rel="icon" href="https://www.feoux.com/favicon.png" type="image/x-icon">
    <noscript>
        <style>
            #backto-top {
                display: none;
...
<div class="axil-breadcrumb-area breadcrumb-style-1 bg-color-grey">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="inner">
                    <ul id="breadcrumbs" class="axil-breadcrumb liststyle d-flex"><li class="item-home"><a class="bread-link bread-home" href="../" title="Home">Home</a></li><li class="separator separator-home">  </li><li class="item-current item-795"><span class="bread-current bread-795"> Ask</span></li></ul>                                            <h1 class="page-title">Ask Now</h1>
...
<style>
	...
	<p>Having any question? Ask for your query to pulishers and find solution of your query.</p>
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
		<label for="user_login"><img src="../assets/images/help.png" style="width: 40px;">Query</label>
		...
		<label for="user_login"><img src="../assets/images/desc.png" style="width: 40px;">Description</label>
		<textarea class="woocommerce-Input woocommerce-Input--text input-text" name="desc" id="desc"/></textarea>
	</p>
	...
	<p class="woocommerce-form-row form-row">
		<button type="submit" class="woocommerce-Button button" value="Ask Now">Ask Now</button>
	</p>
...
<?php
          ...
          if (isset($_POST)) {
            if ($query == '') {
              ...
              $sql = "SELECT * FROM ask WHERE query='$query'";
              $results = mysqli_query($conn, $sql);
              if (mysqli_num_rows($results) > 0) {
                echo "<div style='z-index:100;position:absolute;width:100%;left: 0px;top:5%;'>
                <center>
                    <div id='caption' style='background: #ff7907;color: white;text-align: center;width: 50%;font-family: sans-serif;padding: 10px;border-radius: 10px;'>Request already exist<span style='left: 15%;position: relative;' class='fas fa-times' onclick='document.getElementById(`caption`).style.display=`none`;'></span></div>
            </center>
            </div>";
              } else {
                $sql = "INSERT INTO `ask`(`query`, `desc`) VALUES ('$query','$desc')";
