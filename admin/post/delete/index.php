...
if (isset($_POST['test1'])) {
    require('../../dbcon.php');
    $code =  $_REQUEST['code'];
    $result_query = "SELECT * FROM `post` WHERE `id`='$code'";
    ...
    while ($row_result = mysqli_fetch_array($run_result)) {
        ...
        $channel= strtolower($channel);$channel = str_ireplace(' ', '-', $channel);
...
<div id="id01" class="w3-modal" style="background:transparent">
    ...
    <div class="w3-modal-content" style="border-radius:10px">
      <div class="w3-container">
        <p>If you once Delete Ask you are unable to get it back so think before this action.</p>
        <form action="" method="POST">
        <input type="text" name="code" value="<?php $code =  $_REQUEST['code']; echo"$code"; ?>" readonly required><br>
           <br> <input type="checkbox" name="test1" required>&nbsp;<a style="color:blue;"><u style="font-family:calibri">I Agree to delete this ask</u></a>
