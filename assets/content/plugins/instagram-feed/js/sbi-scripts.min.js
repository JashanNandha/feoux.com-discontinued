...
sbi_js_exists || (! function(i) {
                ...
                i.fn.extend({
                    sbi_imgLiquid: function(e) {
                        ...
                        return this.options = e, this.settings = i.extend({}, this.defaults, this.options), this.settings.onStart && this.settings.onStart(), this.each(function(e) {
                            function n() {
                                (r.responsive || c.data("sbi_imgLiquid_oldProcessed")) && c.data("sbi_imgLiquid_settings") && (r = c.data("sbi_imgLiquid_settings"), l.actualSize = l.get(0).offsetWidth + l.get(0).offsetHeight / 1e4, l.sizeOld && l.actualSize !== l.sizeOld && a(), l.sizeOld = l.actualSize, setTimeout(n, r.responsiveCheckTime))
                            }
                            ...
                            var r = s.settings,
                                l = i(this),
                                c = i("img:first", l);
                            return c.length ? (c.data("sbi_imgLiquid_settings") ? (l.removeClass("sbi_imgLiquid_error").removeClass("sbi_imgLiquid_ready"), r = i.extend({}, c.data("sbi_imgLiquid_settings"), s.options)) : r = i.extend({}, s.settings, function() {
                                var i = {};
                                if (s.settings.useDataHtmlAttr) {
                                    ...
                                    ("true" === e || "false" === e) && (i.fill = Boolean("true" === e)), void 0 === n || "left" !== n && "center" !== n && "right" !== n && -1 === n.indexOf("%") || (i.horizontalAlign = n), void 0 === o || "top" !== o && "bottom" !== o && "center" !== o && -1 === o.indexOf("%") || (i.verticalAlign = o)
                                }
                                return t.isIE && s.settings.ieFadeInDisabled && (i.fadeInTime = 0), i
                            }()), c.data("sbi_imgLiquid_settings", r), r.onItemStart && r.onItemStart(e, l, c), void(t.bgs_Available && r.useBackgroundSize ? (-1 === l.css("background-image").indexOf(encodeURI(c.attr("src"))) && l.css({
                                ...
                                display: "none"
                            }), r.onItemFinish && r.onItemFinish(e, l, c), l.addClass("sbi_imgLiquid_bgSize"), l.addClass("sbi_imgLiquid_ready"), d()) : function s() {
                                if (c.data("oldSrc") && c.data("oldSrc") !== c.attr("src")) {
                                    var t = c.clone().removeAttr("style");
                                    return t.data("sbi_imgLiquid_settings", c.data("sbi_imgLiquid_settings")), c.parent().prepend(t), c.remove(), (c = t)[0].width = 0, void setTimeout(s, 10)
                                }
                                return c.data("sbi_imgLiquid_oldProcessed") ? void a() : (c.data("sbi_imgLiquid_oldProcessed", !1), c.data("oldSrc", c.attr("src")), i("img:not(:first)", l).css("display", "none"), l.css({
                                    overflow: "hidden"
                                    ...
                                    height: "auto",
                                    display: "block"
                                }), c.on("error", o), c[0].onerror = o, function i() {
                                    c.data("sbi_imgLiquid_error") || c.data("sbi_imgLiquid_loaded") || c.data("sbi_imgLiquid_oldProcessed") || (l.is(":visible") && c[0].complete && c[0].width > 0 && c[0].height > 0 ? (c.data("sbi_imgLiquid_loaded", !0), setTimeout(a, e * r.delay)) : setTimeout(i, r.timecheckvisibility))
                                }(), void n())
                            }())) : void o()
                        })
                    }
    ...
    function t(i, e, s) {
        this.el = i, this.index = e, this.settings = s, this.minImageWidth = 0, this.imageResolution = 150, this.resizedImages = {}, this.needsResizing = [], this.outOfPages = !1, this.page = 1, this.isInitialized = !1
    }
    ...
    s.prototype = {
        ...
        createFeeds: function(e) {
            e.whenFeedsCreated(i(".sbi").each(function(e) {
                ...
                var s = i(this),
                    o = void 0 !== s.attr("data-sbi-flags") ? s.attr("data-sbi-flags").split(",") : [],
                    a = void 0 !== s.attr("data-options") ? JSON.parse(s.attr("data-options")) : {};
                if (o.indexOf("testAjax") > -1) {
                ...
                var d = {
                    ...
                    postID: "undefind" != typeof s.attr("data-postid") ? s.attr("data-postid") : "unknown",
                    shortCodeAtts: s.attr("data-shortcode-atts"),
                    resizingEnabled: -1 === o.indexOf("resizeDisable"),
                    imageLoadEnabled: -1 === o.indexOf("imageLoadDisable"),
                    debugEnabled: o.indexOf("debug") > -1,
                    favorLocal: o.indexOf("favorLocal") > -1,
                    ajaxPostLoad: o.indexOf("ajaxPostLoad") > -1,
                    gdpr: o.indexOf("gdpr") > -1,
                    overrideBlockCDN: o.indexOf("overrideBlockCDN") > -1,
                    consentGiven: !1,
                    locator: o.indexOf("locator") > -1,
                    autoMinRes: 1,
                    general: a
                };
        ...
        setImageHeight: function() {
            var e = i(this.el),
                ...
                o = n / 2;
            sbi_photo_width_manual = e.find("#sbi_images").width() / t - n, e.find(".sbi_photo").css("height", s), e.find(".sbi-owl-nav").length && setTimeout(function() {
                var i = 2;
                e.find(".sbi_owl2row-item").length && (i = 1);
                var s = e.find(".sbi_photo").eq(0).innerWidth() / i;
                s += parseInt(o) * (2 - i + 2), e.find(".sbi-owl-nav div").css("top", s)
            }, 100)
        },
        maybeRaiseSingleImageResolution: function(e, s, t) {
            var n = this,
                ...
                d = 150,
                r = e.find("img").get(0),
                l = a === window.sbi.options.placeholder ? 1 : r.naturalWidth / r.naturalHeight;
            t = void 0 !== t && t;
            if (!(e.hasClass("sbi_no_resraise") || e.hasClass("sbi_had_error") || e.find(".sbi_link_area").length && e.find(".sbi_link_area").hasClass("sbi_had_error")))
                if (o.length < 1) e.find(".sbi_link_area").length && e.find(".sbi_link_area").attr("href", window.sbi.options.placeholder.replace("placeholder.png", "thumb-placeholder.png"));
                    ...
                    (e.find(".sbi_link_area").length && e.find(".sbi_link_area").attr("href") === window.sbi.options.placeholder.replace("placeholder.png", "thumb-placeholder.png") || !n.settings.consentGiven) && e.find(".sbi_link_area").attr("href", o[o.length - 1]), void 0 !== o[640] && e.find(".sbi_photo").attr("data-full-res", o[640]), i.each(o, function(i, e) {
                        e === a && (d = parseInt(i), t = !1)
                    });
                    var c = 640;
                    switch (n.settings.imgRes) {
                        ...
                        case "full":
                            ...
                            break;
                        default:
                            var h = Math.max(n.settings.autoMinRes, e.find(".sbi_photo").innerWidth()),
                                g = n.getBestResolutionForAuto(h, l, e);
                            switch (g) {
                                case 320:
                                    c = 320;
                                    break;
                    ...
                    if (c > d || a === window.sbi.options.placeholder || t) {
                        if (n.settings.debugEnabled) {
                            var f = a === window.sbi.options.placeholder ? "was placeholder" : "too small";
                            console.log("rais res for " + a, f)
                        }
                        var u = o[c].split("?ig_cache_key")[0];
                        if (a !== u && (e.find(".sbi_photo img").attr("src", u), e.find(".sbi_photo").css("background-image", 'url("' + u + '")')), d = c, "auto" === n.settings.imgRes) {
                            var b = !1;
                            e.find(".sbi_photo img").on("load", function() {
                                var s = i(this),
                                    t = s.get(0).naturalWidth / s.get(0).naturalHeight;
                                if (1e3 !== s.get(0).naturalWidth && t > l && !b) {
                                    switch (n.settings.debugEnabled && console.log("rais res again for aspect ratio change " + a), b = !0, h = e.find(".sbi_photo").innerWidth(), g = n.getBestResolutionForAuto(h, t, e), c = 640, g) {
                                        case 320:
                                            c = 320;
                                            break;
                                        case 150:
                                    ...
                                    c > d && (u = o[c].split("?ig_cache_key")[0], s.attr("src", u), s.closest(".sbi_photo").css("background-image", 'url("' + u + '")')), "masonry" !== n.layout && "highlight" !== n.layout || (i(n.el).find("#sbi_images").smashotope(n.isotopeArgs), setTimeout(function() {
                                    ...
                                    console.log("not raising res for replacement  " + a, r)
                                }
                            })
                        }
                    }
        ...
        getBestResolutionForAuto: function(e, s, t) {
            ...
            var n = e * s,
                o = 10 * Math.ceil(n / 10),
                a = [150, 320, 640];
            if (t.hasClass("sbi_highlighted") && (o *= 2), -1 === a.indexOf(parseInt(o))) {
                var d = !1;
                i.each(a, function(i, e) {
                    e > parseInt(o) && !d && (o = e, d = !0)
                })
            }
            return o
        },
        ...
        setImageSizeClass: function() {
            ...
            var s = e.innerWidth(),
                ...
                o = (s - t * (n + 2)) / n;
            o > 120 && o < 240 ? e.addClass("sbi_medium") : o <= 120 && e.addClass("sbi_small")
        },
        ...
        locationGuess: function() {
            var e = i(this.el),
                s = "content";
            return e.closest("footer").length ? s = "footer" : e.closest(".header").length || e.closest("header").length ? s = "header" : (e.closest(".sidebar").length || e.closest("aside").length) && (s = "sidebar"), s
        }
    ...
    void 0 === window.sb_instagram_js_options && (window.sb_instagram_js_options = {
        font_method: "svg",
        resized_url: location.protocol + "//" + window.location.hostname + "/assets/content/uploads/sb-instagram-feed-images/",
        placeholder: location.protocol + "//" + window.location.hostname + "/assets/content/plugins/instagram-feed/img/placeholder.png"
