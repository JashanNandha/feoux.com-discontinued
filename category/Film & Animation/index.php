...
<head>
    ...
    <title>Film & Animation &#8211; Feoux</title>   <link rel="icon" href="https://www.feoux.com/favicon.ico" type="image/x-icon"><link rel="icon" href="https://www.feoux.com/favicon.png" type="image/x-icon">
                                ...
                                <div class="container">
                                    <div class="row row--40">
                                        ...
                                        <?php
                                                                                           ...
                                                                                           $sql = "SELECT * FROM `post` WHERE `category` like '%Film & Animation%' ORDER BY `views` DESC LIMIT 20";
