...
<head>
    ...
    <title>Comedy &#8211; Feoux</title>   <link rel="icon" href="https://www.feoux.com/favicon.ico" type="image/x-icon"><link rel="icon" href="https://www.feoux.com/favicon.png" type="image/x-icon">ut-css'  href='../../assets/content/plugins/woocommerce/assets/css/woocommerce-layout.css?ver=5.5.2' type='text/css' media='all' />
...
<div class="axil-breadcrumb-area breadcrumb-style-1 bg-color-grey">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="inner">
                    <ul id="breadcrumbs" class="axil-breadcrumb liststyle d-flex"><li class="item-home"><a class="bread-link bread-home" href="../../" title="Home">Home</a></li><li class="separator separator-home">  </li><li class="item-current item-795"><span class="bread-current bread-795"> Category</span></li></ul>                                            <h1 class="page-title">Comedy</h1>
                                ...
                                <div class="container">
                                    <div class="row row--40">
                                        ...
                                        <?php
                                                                                           ...
                                                                                           $sql = "SELECT * FROM `post` WHERE `category` like '%Comedy%' ORDER BY `views` DESC LIMIT 20";
